              ...
              <Form className="space-y-8">
                ...
                <div className="space-y-6">
                    ...
                    <Field
                        name="title"
                        type="text"
                        className="w-full bg-gray-50 border border-gray rounded-xl px-4 py-3 text-gray-900 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all outline-none"
                    />
                    ...
                    <Field
                        ...
                        name="description"
                        rows="4"
                        className="w-full bg-gray-50 border border-gray rounded-xl px-4 py-3 text-gray-900 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all outline-none resize-none"
                    />
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <Field
                                    name="duration"
                                    type="number"
                                    className="w-full bg-gray-50 border border-gray rounded-xl px-4 py-3 pl-10 text-gray-900 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all outline-none"
                                />
